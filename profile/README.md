...
To get started install the backend located at https://github.com/laravel-liberu/genealogy, then you can find the client application at https://github.com/liberu-genealogy/genealogy-nuxt. Download and explore the user-friendly interface and unleash the power of creating and discovering your family's heritage with ease.
